...
<head>
    ...
    <title>Цифровой рубль 2025: эволюция цифровых денег</title>
    <meta name="description" content="Полная история цифровых валют от Bitcoin до государственных CBDC. Особенности и преимущества цифрового рубля.">
...
<body>
    <section class="hero">
        ...
        <p>От криптовалют к цифровой экономике</p>
    ...
    <section id="history" class="history-section">
        <h2 style="color: var(--secondary); text-align: center;">История цифровой валюты</h2>
        ...
        <div class="history-card">
            <div class="history-icon">
                <img src="https://avatars.mds.yandex.net/i?id=3fe87a1d30d12a848df0c7f7e0e01817_l-11042380-images-thumbs&n=13" alt="Ethereum">
            </div>
            <div>
                <h3>2015: Ethereum</h3>
                <p>Смарт-контракты и блокчейн 2.0</p>
            </div>
        </div>
        ...
        <div class="history-card">
            ...
            <div>
                <h3>2017-2025: Цифровой рубль</h3>
                <p>От исследований ЦБ РФ до массового внедрения</p>
            </div>
        </div>
    </section>
    ...
    <section id="relevance" class="relevance-section">
        ...
        <div class="relevance-grid">
            <div class="relevance-card">
                <h3>Безопасность</h3>
                <p>Защита от мошенничества с помощью блокчейна</p>
            </div>
            <div class="relevance-card">
                <h3>Госинтеграция</h3>
